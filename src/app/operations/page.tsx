    ...
    <main className="min-h-[calc(100vh-4rem)] bg-white">
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="text-center">
          <span className="inline-flex items-center rounded-full px-3 py-1 text-sm font-medium mb-4" style={{ backgroundColor: 'rgba(47, 2, 196, 0.1)', color: '#2f02c4' }}>
        ...
        <div className="mt-16 grid gap-8 md:grid-cols-2">
          {categories.map((category) => (
            <div 
              key={category.id}
              className="rounded-xl border border-gray-200 bg-white p-6 hover:border-[#2f02c4] hover:shadow-lg transition-all"
            >
        ...
        <div className="mt-16 grid gap-6 md:grid-cols-3">
          <div className="rounded-lg border border-gray-200 bg-gray-50 p-6 text-center">
            <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-lg mb-4" style={{ backgroundColor: 'rgba(47, 2, 196, 0.1)' }}>
              <Search className="h-6 w-6" style={{ color: '#2f02c4' }} />
            </div>
          ...
          <div className="rounded-lg border border-gray-200 bg-gray-50 p-6 text-center">
            <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-lg mb-4" style={{ backgroundColor: 'rgba(47, 2, 196, 0.1)' }}>
              <Database className="h-6 w-6" style={{ color: '#2f02c4' }} />
            </div>
          ...
          <div className="rounded-lg border border-gray-200 bg-gray-50 p-6 text-center">
            <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-lg mb-4" style={{ backgroundColor: 'rgba(47, 2, 196, 0.1)' }}>
              <BarChart3 className="h-6 w-6" style={{ color: '#2f02c4' }} />
            </div>
