...
const operations = [
  ...
  {
    id: 'langfuse',
    name: 'Langfuse Operations',
    iconName: 'Database',
    description: 'Self-hosted Langfuse for local tracing and evaluation workflows. Start with a single-machine Docker Compose quickstart that includes web, worker, Postgres, ClickHouse, Redis, and MinIO.',
    docs: '/learn/langfuse/overview',
    github: 'https://github.com/VibhuviOiO/infinite-containers/tree/main/langfuse',
    tags: ['Observability', 'LLM', 'Docker'],
    lessons: 2,
    duration: '50m',
  ...
  },
  {
    ...
    iconName: 'Network',
    description: 'Platform-engineering the LiteLLM AI gateway — from a local Ollama setup with fallback you can trigger, through five free-tier providers behind one endpoint, to AWS Bedrock in dev and production shapes with virtual keys, response cache, and an honest gap table.',
    docs: '/learn/lite-llm/overview',
    github: 'https://github.com/VibhuviOiO/infinite-containers/tree/main/lite-llm',
    tags: ['AI Gateway', 'LLM', 'Bedrock'],
    lessons: 7,
    duration: '3h 30m',
    level: 'Advanced' as const,
    updated: 'Jun 2026',
