      ...
      >
        {currentConv.messages.slice(0, visibleCount).map((msg, i) => (
          ...
          >
            ...
            >
              <p className={`text-sm leading-relaxed ${msg.from === 'user' ? 'text-gray-700' : 'text-gray-800 font-medium'}`}>
                {msg.text}
              </p>
            </div>
          </div>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-4">
              <Link
                href="/products"
                className="inline-flex items-center justify-center gap-2 rounded-lg px-6 py-3 text-sm font-semibold text-white transition-all hover:opacity-90 bg-gradient-primary shadow-primary"
              >
                Explore Products
              </Link>
              <Link
          ...
          <div className="grid gap-6" style={{ gridTemplateColumns: '1fr 1fr', gridTemplateRows: 'auto auto 1fr', gridTemplateAreas: '"badge badge" "title title" "center right"' }}>
            ...
            <div className="justify-self-end self-center max-w-md px-4" style={{ gridArea: 'center' }}>
              ...
              <div className="flex flex-wrap gap-3 mb-6">
                <span className="tag-primary px-4 py-2 rounded-full text-sm font-medium">Error Budgets</span>
                <span className="tag-primary px-4 py-2 rounded-full text-sm font-medium">Latency Targets</span>
                <span className="tag-primary px-4 py-2 rounded-full text-sm font-medium">Availability Guarantees</span>
              </div>
        ...
        <div className="relative z-10 mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-10">
            <div className="text-center mb-2">
              <span className="badge-cyan inline-block px-4 py-1.5 rounded-full text-xs font-semibold uppercase tracking-wider">
                Collaborative Approach
              </span>
            </div>
            <h2 className="text-center text-3xl font-extrabold text-gray-900 sm:text-4xl tracking-tight mb-3">
              We Listen to Your Team
            </h2>
          ...
          <div className="mt-10 flex justify-center">
            <div className="inline-flex items-center gap-6 px-6 py-3 bg-white/80 backdrop-blur-sm rounded-full border border-gray-200 shadow-sm">
              <div className="flex items-center gap-2">
                <span className="w-3 h-3 rounded-full bg-orange-400"></span>
                <span className="text-sm text-gray-700">You share problem</span>
              </div>
              <span className="text-gray-300">→</span>
              <div className="flex items-center gap-2">
                <span className="w-3 h-3 rounded-full bg-primary"></span>
                <span className="text-sm text-gray-700">We discuss & design</span>
              </div>
              <span className="text-gray-300">→</span>
              <div className="flex items-center gap-2">
                <span className="w-3 h-3 rounded-full bg-green-500"></span>
                <span className="text-sm text-gray-700">Build solution</span>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 lg:py-20 bg-gray-50">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-8">
            <Link
              href="/docs"
              className="inline-flex items-center justify-center gap-2 rounded-lg px-8 py-4 text-base font-semibold text-white transition-all hover:opacity-90 bg-gradient-primary shadow-primary"
            >
              Get Started
            </Link>
          </div>
