    ...
    <nav className="sticky top-0 z-50 w-full border-b border-gray-200 bg-white/80 backdrop-blur-xl">
      <div className="flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden md:flex items-center gap-1">
          ...
          <Link
            href="/docs"
            className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-600 hover:text-[#2f02c4] transition-colors rounded-lg hover:bg-gray-50"
          >
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center justify-center p-2 text-gray-600 hover:text-[#2f02c4] transition-colors rounded-lg hover:bg-gray-100 ml-2"
              title="Products"
            >
